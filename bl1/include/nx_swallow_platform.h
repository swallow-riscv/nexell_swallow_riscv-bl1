...
#define mmio_read_64(addr)              (*(volatile unsigned long  *)(addr))
...
#define mmio_write_64(addr,data)        (*(volatile unsigned long  *)(addr))  =  ((unsigned long  )(data))
...
#define mmio_set_64(addr,data)          (*(volatile unsigned long  *)(addr)) |=  ((unsigned long  )(data))
...
#define mmio_clear_64(addr,data)        (*(volatile unsigned long  *)(addr)) &= ~((unsigned long  )(data))
